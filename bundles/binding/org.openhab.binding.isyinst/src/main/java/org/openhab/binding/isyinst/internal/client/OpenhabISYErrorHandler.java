...
public class OpenhabISYErrorHandler implements ErrorEventListener{
	 ...
	 * @return - whether or not the client attempt displaying the error
	 * on a UI. if a <code>GUIErrorHandler</code> is installed, that object is invoked (showError)
	 */
